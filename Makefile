...
source_files = src/main.cpp src/mutil.cpp src/window.cpp src/subview.cpp src/uidisplay.cpp src/Herix/src/herix.cpp src/Herix/src/editstorage.cpp src/Herix/src/types.cpp
